      ...
      <div className="p-5 space-y-6">
        ...
        <div className="grid grid-cols-2 gap-3">
          <motion.div 
            ...
            className="bg-linear-to-br from-blue-600 to-blue-800 p-4 rounded-2xl shadow-lg shadow-blue-500/20 relative overflow-hidden group cursor-pointer hover:opacity-90 transition-all border border-blue-400/20"
          >
