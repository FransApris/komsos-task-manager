        ...
        <section className="space-y-3">
          ...
          <div className={`bg-[#151b2b] p-5 rounded-3xl border border-gray-800 shadow-xl transition-all ${!isLocationValid ? 'opacity-50 grayscale' : ''}`}>
            <div className="flex flex-col items-center text-center">
              {selfieImg ? (
                <div className="relative w-full aspect-square max-w-60 rounded-2xl overflow-hidden border-4 border-emerald-500/30 shadow-2xl mb-4 group">
                ...
                <div className="w-full aspect-square max-w-60 bg-[#0a0f18] rounded-2xl border-2 border-dashed border-gray-800 flex flex-col items-center justify-center gap-4 mb-4 text-gray-600">
              ...
              <button 
                ...
                className={`w-full max-w-60 py-4 rounded-2xl font-bold text-sm flex items-center justify-center gap-2 transition-all shadow-lg ${
                  selfieImg 
