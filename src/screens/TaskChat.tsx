                ...
                <div className={`rounded-2xl shadow-sm min-w-[140px] w-full overflow-hidden ${
                  ...
                  {msg.replyTo && (
                    <div className={`px-3 pt-2.5 pb-1.5 border-b ${
                      isCurrentUser(msg.senderId) ? 'border-blue-500/40 bg-blue-700/40' : 'border-gray-700 bg-[#0a0f18]/60'
                    }`}>
                      <p className={`text-[9px] font-bold uppercase tracking-wider mb-0.5 ${
                        isCurrentUser(msg.senderId) ? 'text-blue-200' : 'text-blue-400'
                      }`}>
                        ↩ {msg.replyTo.senderName}
                      </p>
                      <p className={`text-[11px] line-clamp-2 ${
                        isCurrentUser(msg.senderId) ? 'text-blue-100/70' : 'text-gray-400'
                      }`}>
                        {msg.replyTo.text}
                      </p>
                    </div>
