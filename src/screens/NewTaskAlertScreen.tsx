      ...
      <div className="flex-1 flex flex-col p-6 justify-center">
        ...
        >
          <button
            ...
            className="w-full bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-black py-5 rounded-2xl shadow-2xl shadow-blue-500/30 flex items-center justify-center gap-3 group active:scale-95 transition-all uppercase tracking-widest text-sm"
          >
            Masuk ke Dashboard
