                    ...
                    >
                      ...
                      <div className="flex items-center justify-between mt-auto pt-3 border-t border-gray-800">
                        <div className="flex items-center gap-1.5 text-[9px] font-bold text-gray-400">
                          ...
                          <span className="truncate max-w-20">{item.pic || 'Belum diisi'}</span>
                        </div>
                        {item.targetDate && (
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <input 
                  ...
                  className="w-full bg-[#0a0f18] border border-gray-800 rounded-xl px-4 py-3.5 text-sm text-white focus:border-blue-500 outline-none scheme-dark"
                />
              </div>
              <div>
