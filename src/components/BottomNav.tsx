...
export const BottomNav: React.FC<BottomNavProps> = ({ 
  ...
  return (
    <div className="fixed bottom-6 left-1/2 -translate-x-1/2 w-[90%] max-w-md z-50 safe-area-bottom">
      <div className="bg-[#151b2b]/60 backdrop-blur-2xl border border-white/10 rounded-4xl p-2 shadow-2xl shadow-black/50 flex justify-between items-center relative overflow-hidden">
        {navItems.map((item) => {
